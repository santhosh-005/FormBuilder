...
import { Mail, Lock, UserPlus, FormInput, Shield } from 'lucide-react';
...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { user: firebaseUser, error: signUpError } = await signup(email, password);
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label htmlFor="confirmPassword" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                      <div className="w-5 h-5 bg-gradient-to-r from-indigo-500 to-blue-600 rounded-lg flex items-center justify-center">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md"
